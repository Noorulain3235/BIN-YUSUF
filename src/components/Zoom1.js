...
export default function ProductPage() {
  ...
  const [mainImage, setMainImage] = useState('/images/arr1.jpeg');
    ...
    <>
      <div className="product-page">
        ...
        <div className="product-details">
          <h1>SAIRA RIZWAN COTTON SILK</h1>
          <div className="stars">⭐⭐⭐⭐⭐</div>
          <p className="price">₨ 4,850.00</p>
          <p className="categories">
            Categories: <strong>3 Piece, COTTON,SAIRA RIZWAN COTTON SILK</strong>
          </p>
          <p className="availability">
            Availability: <span className="green">30 in stock</span>
          </p>
