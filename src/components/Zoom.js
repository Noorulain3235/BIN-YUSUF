...
export default function ProductPage() {
  ...
  const [mainImage, setMainImage] = useState('/images/arr8.jpeg');
    ...
    <>
      <div className="product-page">
        ...
        <div className="product-details">
          <h1>Majestic M4-00003</h1>
          <div className="stars">⭐⭐⭐⭐⭐</div>
          <p className="price">Rs 5,990</p>
          <p className="categories">
            Categories: <strong>3 Piece, Lawn, Majestic, Summer, V4</strong>
          </p>
          <p className="availability">
            Availability: <span className="green">2 in stock</span>
          </p>
