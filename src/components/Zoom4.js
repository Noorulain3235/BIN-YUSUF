...
export default function ProductPage() {
  ...
  const [mainImage, setMainImage] = useState('/images/arr4.jpeg');
    ...
    <>
      <div className="product-page">
        ...
        <div className="product-details">
          <h1>JAZMINE LAWN ORGANZA</h1>
          <div className="stars">⭐⭐⭐⭐⭐</div>
          <p className="price">₨ 4,850.00</p>
          <p className="categories">
            Categories: <strong>3 Piece, JAZMINE LAWN ORGANZA</strong>
          </p>
          <p className="availability">
            Availability: <span className="green">8 in stock</span>
          </p>
